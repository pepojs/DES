...
#        self.color2 = QtGui.QColor(QtCore.Qt.red)
...
#        paint2=QtGui.QPainter(self)
#        paint2.setPen(QtGui.QPen(QtGui.QColor(self.color2),1,QtCore.Qt.SolidLine))
#        paint2.setBrush(self.color2)
#        paint2.drawEllipse(50,0, 20, 20)
